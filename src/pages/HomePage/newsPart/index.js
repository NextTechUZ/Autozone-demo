...
export function News(){
    return(
        <div className={styles.newspart}>
            <div className={styles.title}><Titles head='новости'/></div>
                ...
                <div>
                    <div className={styles.newsCard}>
                        ...
                        <div className={styles.newbottom}>
                            ...
                            <button className={styles.unionfirst}><img src={Union}/></button>
                        </div>
                    </div>
                    <div className={styles.newsCard}>
                        ...
                        <div className={styles.newbottom}>
                            ...
                            <button className={styles.union}><img src={Union}/></button>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <button className={styles.newsButton}>ЧИТАТЬ ВСЕ НОВОСТИ</button>
        </div>
    )
}